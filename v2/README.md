...
- **Хөдөлгүүр:** Unity (2022.3 LTS буюу шинэ).
- **Платформ:** iOS + Android нэг кодоор.
- **Эхлэл:** нэг хот (Отрар), 2–4 тоглогчийн co-op босоо зүсэлт (vertical slice).
...
2. Package Manager → **Netcode for GameObjects** (эсвэл Mirror — `Net/` интерфейс солигдоно).
